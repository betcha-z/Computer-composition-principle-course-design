...
HD_PWD='C:/Users/zhangtaoyuan/FPGA/Expr2_Regs/Expr2_Regs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Regs_ALU_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Regs_ALU_Top.tcl
