...
HD_PWD='C:/Users/zhangtaoyuan/FPGA/Expr2_Regs/Expr2_Regs.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Regs_ALU_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Regs_ALU_Top.tcl -notrace
