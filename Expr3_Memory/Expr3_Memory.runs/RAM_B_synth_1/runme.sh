...
HD_PWD='C:/Users/zhangtaoyuan/FPGA/Expr3_Memory/Expr3_Memory.runs/RAM_B_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_B.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_B.tcl
