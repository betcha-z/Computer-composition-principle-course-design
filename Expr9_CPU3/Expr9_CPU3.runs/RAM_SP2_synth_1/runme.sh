...
HD_PWD='C:/Users/zhangtaoyuan/FPGA/Expr9_CPU3/Expr9_CPU3.runs/RAM_SP2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_SP2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_SP2.tcl
