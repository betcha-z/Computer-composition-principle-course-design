...
HD_PWD='C:/Users/zhangtaoyuan/FPGA/Expr9_CPU3/Expr9_CPU3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU3_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CPU3_Top.tcl -notrace
