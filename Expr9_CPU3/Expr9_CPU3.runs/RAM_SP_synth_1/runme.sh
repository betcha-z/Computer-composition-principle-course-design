...
HD_PWD='C:/Users/zhangtaoyuan/FPGA/Expr8_CPU2/Expr8_CPU2.runs/RAM_SP_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_SP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_SP.tcl
