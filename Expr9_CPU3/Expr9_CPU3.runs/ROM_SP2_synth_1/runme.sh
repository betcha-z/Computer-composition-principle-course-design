...
HD_PWD='C:/Users/zhangtaoyuan/FPGA/Expr9_CPU3/Expr9_CPU3.runs/ROM_SP2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_SP2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROM_SP2.tcl
