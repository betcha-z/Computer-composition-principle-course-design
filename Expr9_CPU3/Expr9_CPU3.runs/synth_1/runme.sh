...
HD_PWD='C:/Users/zhangtaoyuan/FPGA/Expr9_CPU3/Expr9_CPU3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU3_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU3_Top.tcl
