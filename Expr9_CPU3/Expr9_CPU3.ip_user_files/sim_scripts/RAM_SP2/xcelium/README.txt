...
#
# Generated by export_simulation on Sat Jun 19 12:08:24 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './RAM_SP2.sh' script.

./RAM_SP2.sh -reset_run
...
./RAM_SP2.sh -noclean_files

For more information on the script, please type './RAM_SP2.sh -help'.
