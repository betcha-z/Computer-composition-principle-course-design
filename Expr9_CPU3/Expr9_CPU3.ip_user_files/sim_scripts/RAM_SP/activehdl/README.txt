...
#
# Generated by export_simulation on Tue Jun 15 21:28:40 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './RAM_SP.sh' script.
...
./RAM_SP.sh -noclean_files

For more information on the script, please type './RAM_SP.sh -help'.
