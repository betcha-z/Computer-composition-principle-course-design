...
HD_PWD='C:/Users/zhangtaoyuan/FPGA/Expr6_Instruction/Expr6_Instruction.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fetch_Show_T.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fetch_Show_T.tcl
