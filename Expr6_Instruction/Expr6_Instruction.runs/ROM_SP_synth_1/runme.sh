...
HD_PWD='C:/Users/zhangtaoyuan/FPGA/Expr6_Instruction/Expr6_Instruction.runs/ROM_SP_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_SP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROM_SP.tcl
