...
#
# Generated by export_simulation on Sat May 29 19:16:30 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './ROM_SP.sh' script.
...
./ROM_SP.sh -noclean_files

For more information on the script, please type './ROM_SP.sh -help'.
